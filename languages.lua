return {
	es = {
        ...
        getban = {
            ...
            arab = 'Expulsado por hablar en árabe: ',
	    ...
	    bonus = {
            ...
            msg_me = '_Envíame un mensaje al privado para poder ayudarte._',
            menu_cb_settings = '¡Pulsa un icono!',
            menu_cb_warns = 'Usa la fila de abajo para cambiar los ajustes de advertencias.',
            menu_cb_media = 'Pulsa un ícono para cambiar su status.',
            tell = '*ID del grupo*: &&&1'
        },
        not_mod = 'Tu *no* eres moderador',
        breaks_markdown = 'Este texto no sigue las normas del Markdown.\nPara más información, haz [click aquí](https://telegram.me/Moderador_Channel/163).',
        ...
        extra = {
            ...
            using = 'Escribe despues de /extra algún titulo de comando que sea asociado al activar.\nPor ejemplo: /extra #baile vamos a bailar. El bot responderá *vamos a bailar.* cuando alguien escriba #baile. Puedes usar incluso gif, stickers, etc.'
        },
        help = {
            mods = {
                banhammer = "*Moderadores: ajustes para baneos*\n\n"
                            ...
                            .."la segunda muestra algunas estadísticas generales del usuario: mensajes/archivos en el grupo, advertencias recibidas y si está activo.\n"
                            ...
                            .."`/spam [enable|disable]` = Si esta deshabilitado _(disable)_, expulsa o banea a cualquiera que envíe un enlace del tipo (http://t.me, http://telegram.me/joinchat o telegra.ph), puede advertir antes del baneo (si es que el bot está de buenas).\n"                            
                            .."`/bots [enable|disable] (nuevo)` = Si está deshabilitado _(disable)_, expulsa y bloquea a cualquier bot que sea agregado por miembros que no sean admins del grupo (No aplica administradores).\n"
                            .."`/groseria [enable|disable] (nuevo)` = Si está deshabilitado _(disable)_, expulsa y bloquea a cualquier miembro que use un vocabulario grosero o vulgar del grupo (No aplica administradores, puede advertir antes del baneo).\n"
            ...
            all = '*Comandos para todos*:\n'
                    ...
                    ..'`/kickme`: El bot te expulsará del grupo en donde envíes el comando.\n'
                   -- ..'`/faq`: some useful answers to frequent quetions\n'
                    ...
                    ..'`!` <feedback> : envía un feedback al administrador del bot, podrías reportar un error si lo encuentras, a través del privado.\n'
                    ..'`/help`: Ver este mensaje.'
		            ..'\n\nSi te gusta este bot, por favor deja tu voto [aqui](https://telegram.me/storebot?start=TheGrandFatherBot)',
		    private = '¡Hola *&&&1*!\n'
                   ..'Soy El Padrino Bot, un _bot moderador_ para tus grupos.\n'
                   ..'\n*¿Como puedo ayudarte?*\n'
                   ..'\nPuedes obtener más información sobre nuestro bot o sugerencias\n'
                   ..'\nPuedes invitarme a un [café con galletas](https://goo.gl/ynpQuU) ;)\n'
                   ...
                   ..'\nPara obtener mas información, puedes ingresar al canal público [El Padrino Español](https://telegram.me/Moderador_Channel)\n'
                   ..'\nSi deseas asistencia, por favor agrega a mi dueño [HuterCR](http://telegram.me/HuterCR) o a [єνєяувσ∂уσηнρ](http://telegram.me/EveryBodyOnHp), ellos me configurarán en tu grupo.\n\nRecuerda que el uso del bot se encuentra sujeto a nuestros *términos de uso*; los encontrarás entre los botones. Al hacer uso del bot, obviamos que los aceptas. ',
            group_success = 'ℹ️ Te he enviado un mensaje por privado, *verifícalo*.',
        ...
        links = {
            no_link = '*No hay enlace* para este grupo. Pídele al admin que lo añada',
            link = '[&&&1](&&&2)',
            link_invalid = 'Este enlace *no* es válido.',
            link_no_input = 'Este no es un *supergrupo público*, por lo que necesitas usar /setlink para establecer el link del grupo',
        ...
        mod = {
            ...
            reply_promote = 'ℹ️ Respóndele a alguien para promoverlo.',
            reply_demote = 'ℹ️ Respóndele a alguien para removerlo de la lista de admins/mods.',
            reply_owner = 'ℹ️ Respóndele a alguien para promoverlo a administrador.',
        ...
        report = {
            no_input = 'Escribe tus comentarios/bugs/dudas después del !',
            sent = '¡Mensaje enviado!',
            feedback_reply = '*Hello, this is a reply from the bot owner*:\n&&&1',
        },
        service = {
            welcome = 'Hola &&&1, bienvenido/a a *&&&2*!',
            welcome_rls = '¡El creador no ha establecido normas para el grupo en este bot!',
            welcome_abt = 'No hay descripción sobre este grupo.',
            welcome_modlist = '\n\n*Creador/a*:\n&&&1\n*Admins*:\n&&&2',
            abt = '\n\n*Descripcion*:\n',
            rls = '\n\n*Reglas*:\n',
        ...
        setabout = {
            ...
            no_bio_add = '*No hay descripción* de este grupo.\nUsa /setabout [bio] para añadir una descripcion',
            no_input_add = 'Por favor, escribe algo después de "/addabout"',
            added = '*Descripción añadida:*\n"&&&1"',
            no_input_set = 'Por favor, escribe algo después de "/setabout"',
        ...
        setrules = {
            ...
            no_input_add = 'Por favor, escribe algo después de "/addrules"',
            added = '*Reglas añadidas:*\n"&&&1"',
            no_input_set = 'Por favor, escribe algo después de "/setrules"',
        ...
        settings = {
            disable = {
                ...
                welcome_locked = 'El mensaje de bienvenida no será mostrado',
            ...
            char = {
                arab_kick = 'Los que envien mensajes en árabe serán expulsados',
                arab_ban = 'Los que envíen mensajes en árabe serán baneados',
                arab_allow = 'Árabe permitido',
                rtl_kick = 'El uso de letras RTL o árabes resultará en un kick.',
                rtl_ban = 'El uso de letras RTL o árabes resultará en un baneo.',
        ...
        warn = {
            ...
            changed_type = 'Nueva consecuencia al alcanzar el número máximo de advertencias: *&&&1*',
            mod = 'Un moderador *no* puede ser advertido.',
            warned_max_kick = '*&&&1 ha sido expulsado*: alcanzado el número máximo de advertencias',
            warned_max_ban = '*&&&1 ha sido baneado*: alcanzado el número máximo de advertencias',
            warned = '*&&&1 ha sido advertido.*\n_Número de advertencias_   *&&&2*\n_Maximo_   *&&&3*',
            warnmax = 'Número máximo de advertencias cambiado&&&3.\n*Antes*: &&&1\n*Ahora*: &&&2',
            getwarns_reply = 'Responde a un usuario para obtener el informe de advertencias.',
            getwarns = '&&&1 (*&&&2/&&&3*)\nMedia: (*&&&4/&&&5*)',
            warn_removed = '*¡Advertencia removida!*\n_Número de advertencias_   *&&&1*\n_Máximo permitido_   *&&&2*',
            nowarn_reply = 'Menciona al miembro para eliminarle la advertencia',
            ban_motivation = 'Demasiadas advertencias',
            inline_high = 'El nuevo valor es muy alto... (>12)',
            inline_low = 'El nuevo valor es muy bajo...(<1)',
            zero = 'La cantidad de advertencias para este usuario ahora es _cero_.',
		...
		banhammer = {
            kicked = '(Admin: &&&1)\n\nEl usuario *&&&2* ha sido expulsado del grupo, pero puede volver a entrar si tiene el enlace, o alias, del grupo.',
            banned = '(Admin: &&&1)\n\nEl usuario *&&&2* ha sido baneado del grupo.\nLos enlaces de invitación ya no funcionarán para él o ella.',
            unbanned = 'Usuario desbaneado.\n\nEs posible que debas enviarle el enlace de invitación para que pueda entrar.',
            reply = 'Debes responder a alguien para que este comando tenga algún efecto.',
            ...
            already_banned_normal = '&&&1 *ya fue expulsado*',
            not_banned = 'Este usuario no está expulsado.',
            banlist_header = '*Usuarios baneados*:\n\n',
            banlist_empty = '_La lista está en blanco_',
            banlist_error = '_Un error ha sucedido al intentar limpiar la lista de usuarios baneados_',
            banlist_cleaned = '_Todos los usuarios en la lista de baneados han sido removidos._',
            tempban_zero = 'Te recomiendo usar /ban',
            tempban_week = 'El tiempo máximo es de una semana. (10.080 minutos)',
            tempban_banned = 'El usuario &&&1 ha sido baneado. El baneo expira en:',
            tempban_updated = 'el tiempo de baneo fue actualizado a &&&1. Ahora el baneo expira en:',
            general_motivation = 'No he podido expulsar a este usuario.\nAsegúrate de que soy administrador y que el usuario que quieres expulsar no sea un administrador también.'
        },
        floodmanager = {
            number_invalid = '¡`&&&1` no es un valor permitido!\nEl valor tiene que ser *mayor* que `3` o *menor* que `26`',
            not_changed = 'El número máximo de mensajes que pueden ser enviados en 5 segundos es &&&1',
            changed_plug = 'El número máximo de mensajes que pueden ser enviados en 5 segundos por &&&1 a &&&2',
            ...
            number_cb = 'Actual valor. C´cámbialo con + o -',
        ...
        mediasettings = {
			warn = 'Este tipo de multimedia, o SPAM, *no está permitida* en este grupo.\n_La próxima vez_ podrías ser baneado o expulsado, dependiendo de cuantas advertencias hayas recibido.',
        ...
        preprocess = {
            ...
            rtl_kicked = '&&&1 *expulsado*: ¡Las letras RTL en el nombre o mensage se encuentran prohibidos!',
            arab_kicked = '&&&1 *expulsado*: mensaje árabe detectado',
            rtl_banned = '&&&1 *Baneado*: ¡Las letras RTL en el nombre o mensaje se encuentran prohibidos!',
            arab_banned = '&&&1 *baneado*: árabe detectado!',
            flood_motivation = 'Baneado por flood',
            media_motivation = 'Envía multimedia prohibida',
            first_warn = 'Este tipo de multimedia *no está permitida* en este grupo.\n_La próxima vez_ podrías ser baneado o expulsado, dependiendo de cuantas advertencias hayas recibido',
        },
        kick_errors = {
            ...
            [4] = 'El usuario no es participante de este chat.',
        },
        flag = {
            no_input = 'Respónde al mensaje para reportarlo al administrador o escribe algo despues de \'@admin\' para enviarle un mensaje',
            reported = '¡Mensaje enviado a los administradores del grupo!',
        ...
        all = {
            dashboard = {
                private = '_Te he enviado toda la información del grupo en privado_',
            ...
            menu = 'Te he enviado un mensaje por privado.',
            menu_first = 'Controla los ajustes del grupo.\n'
                ..'\nAlgunos comandos (_/rules, /about, /adminlist, #extra commands_) pueden ser *deshabilitados para tus usuarios*\n'
                ..'Lo que sucede si un comando es deshabilitado para los usuarios:\n'
                ..'• Si el comando fue ejecutado por un admin, el bot *va a responder en el grupo.*\n'
                ..'• Si el comando fue ejecutado por un usuario, el bot *va a enviar un mensaje al privado* (Obviamente, el usuario debe tener el bot iniciado en su privado).\n'
                ..'\nLos iconos en los comandos van a mostrar el status del mismo:\n'
                ..'• 👥: el bot va a responder *en el grupo* para todos\n'
                ..'• 👤: el bot *va a responder en el privado del usuario*, excepto para admins.\n'
                ..'\n*Otros ajustes*: for the other settings, icon are self explanatory\n',
            media_first = 'Toca los botones correspondientes para *cambiar los ajustes*\n'
                        ..'Puedes ajustar en la fila final lo que va a suceder con aquel usuario que sobrepase las limitaciones por multimedia prohibida.\n'
                        ..'Recuerda que estos números son independientes del que hayas configurado para el comando /warn. ',
        },
    },
    ...
    en = {
        status = {
            kicked = '&&&1 is banned.',
            left = '&&&1 left the group or is unbanned.',
            administrator = '&&&1 is an admin',
            creator = '&&&1 is the group creator',
            unknown = 'This user is not to do anything in this chat.',
            member = '&&&1 is a member in this chat'
        },
        userinfo = {

...
pre_process = function(msg, ln)
   if msg.from.id and is_blocked_global(msg.from.id) then
       ...
       api.sendMessage(msg.chat.id,"El usuario que acaba de participar se encuentra en la lista negra de este bot.\nConsulta a @EveryBodyOnHp para más información.",true)
